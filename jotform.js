...
//                        p.$jot('.jt-content, .jt-title').css('width', 'auto');
                ...
                if (combinedObject && "year" in combinedObject || resultFieldType === 'time') {
                    ...
                    try {
                        if ((typeof output == "number" && output > 0) || (typeof output == "string" && output.replace(/\s/g, "").length > 0 && output !== "0")) {
                            ...
                            var date = JotForm.convertUTCDateToLocalDate(new Date(output));
                            var year = date.getFullYear();
    ...
    */
    ...
    countTotal: function (prices) {
        ...
        var stripePEForms = ['230751130589051', '230661480423046', '230644737493059', '230335152243141','212213908647052','203308054705852','213615912681052','230027914831855','223542018983357','210975904790060','223317122437852','222212837800044','222642516438961','211021879199360','203145796449364','223354077922154','203444782055152','230035403861143','211853833106351','230078477443258','221224373329148','222568807379167','222524747985064','213011954934958','93073519781363','200184092222039','223394341731554','213254679777168','71415391642151','223371864275461','82938331545159','221230383976154','210882584153357','222056579330051','220117695853056','213475933547060','223605802566153','222442974250353','213566995088170','230226891265154','223214502809954','92262261709962','223604855446157','201272647249053','223412146469960','213114793110040','222684926137059','91992343515361','202291011986048','211864097311151','213548286577166','212307415940045','221592377831360','91982153529364','222134992823155','210327216660043','82616258895168','203366655186159','202134529699160','82261221476856','200273841707149','202174299286059','223326272681051'];
        var stripeFormID = $$('input[name="formID"]')[0].value;
        if (JotForm.stripe && typeof JotForm.stripe !== undefined && (window.location.search === '?paymentElements=1' || window.location.search === '?stripeLinks=1' || stripePEForms.includes(stripeFormID) || (typeof JotForm.stripePaymentLink !== 'undefined' && JotForm.stripePaymentLink === 'Yes'))) {
      ...
      questions.each(function(question) {
        if (question) {
          ...
          case 'control_stripe':
              var stripePEForms = ['230751130589051', '230661480423046', '230644737493059', '230335152243141','212213908647052','203308054705852','213615912681052','230027914831855','223542018983357','210975904790060','223317122437852','222212837800044','222642516438961','211021879199360','203145796449364','223354077922154','203444782055152','230035403861143','211853833106351','230078477443258','221224373329148','222568807379167','222524747985064','213011954934958','93073519781363','200184092222039','223394341731554','213254679777168','71415391642151','223371864275461','82938331545159','221230383976154','210882584153357','222056579330051','220117695853056','213475933547060','223605802566153','222442974250353','213566995088170','230226891265154','223214502809954','92262261709962','223604855446157','201272647249053','223412146469960','213114793110040','222684926137059','91992343515361','202291011986048','211864097311151','213548286577166','212307415940045','221592377831360','91982153529364','222134992823155','210327216660043','82616258895168','203366655186159','202134529699160','82261221476856','200273841707149','202174299286059','223326272681051'];
              var stripeFormID = $$('input[name="formID"]')[0].value;
              if (window.location.search === '?paymentElements=1' || window.location.search === '?stripeLinks=1' || stripePEForms.includes(stripeFormID) || (typeof JotForm.stripePaymentLink !== 'undefined' && JotForm.stripePaymentLink === 'Yes')) {
                  break;
              }
              var email = $this.hasQuestion(questions, 'control_email');
              if (email !== false) {
